...
const ProductDetails = () => {
  ...
  return (
    <div className="flex flex-col min-h-screen bg-white items-center my-35 justify-center px-4 sm:px-6 md:px-12">
      {/* Main Product Card */}
      <div className="flex flex-col items-center justify-center space-y-6 w-1/2 max-w-3xl">
       {product.images?.length > 0 && (
  <div className="relative w-full max-w-sm mx-auto mb-4 rounded-xl shadow-lg overflow-hidden">
    <Swiper
    ...
    >
      {product.images.map((img, idx) => (
        <SwiperSlide key={idx} className="w-full h-[220px] sm:h-[250px] md:h-[280px] flex justify-center items-center">
          <img
            src={img.url}
